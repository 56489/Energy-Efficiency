...
The tables are displayed for both categorical variable "Orientation" and "Glazing Are Distribution"to show that the  
...
"Glazing Area Distribution" has the four values of the cardinal directions and includes also"Uniform" 
...
### Question 1: Which are the most infuential variables when predicting the cooling efficiency?
